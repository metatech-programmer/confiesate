...
const Form = ({ showModalProp }) => {
  ...
  const [showModalPropState, setShowModalPropState] = useState(showModalProp);
  const [animated, setAnimated] = useState(false);

  useEffect(() => {
    setShowModalPropState(showModalProp);
  }, [showModalProp]);

  const handleModal = () => {
    setShowModalPropState(!showModalPropState);
  };
  ...
  return (
    <div
      className={` fixed top-0 left-0  w-screen h-dvh  z-[70]   flex  ${
        showModalPropState ? "visible" : "hidden"
      }`}
    >
      <div
      ...
      <div className="w-[800px] transition-all h-max m-auto px-4 py-8 md:py-4 animate-expand scale-95  z-[80]  text-white bg-app-bluePurple rounded-3xl ">
        <button
        ...
        <div>
          ...
          <div className="bg-white rounded-2xl p-6 md:p-10 shadow-sm text-app-bluePurple font-open-sans">
