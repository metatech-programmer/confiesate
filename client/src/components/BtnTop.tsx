...
const BtnTop = () => {
  ...
  return (
    <button
      ...
      onClick={scrollToTop}
      className="fixed bottom-20 md:bottom-4 right-4 font-extrabold h-12 w-12  md:h-16 md:w-16 flex justify-center items-center text-5xl animate-fade-in-up p-2 rounded-full shadow-lg hover:bg-app-red bg-app-red/50 border-2 border-app-red md:hover:scale-110 active:scale-110 transition-all z-50"
    >
